    ...
    MNDFeeder.feed = function(visualizationType, feeds, analysisObjects) {
        ...
        for ( i = 0; i < defs.length; i++) {
            ...
            if (values && def.mndMode() !== BindingDefConst.MND_MODE_NONE && def.min() > values.length) {
                if (def.mndMode() === BindingDefConst.MND_MODE_SUPPORT || def.mndMode() === BindingDefConst.MND_MODE_ONLY || (def.mndMode() === BindingDefConst.MND_MODE_SUPPORT_EXCLUSIVELY && values.length === 0)) {
                    values.push(mnd);
                    return;
                }
            }
        ...
        for ( i = 0; i < defs.length; i++) {
            def = defs[i];
            values = FeedUtils.getFeedValues(feeds, def.id());
            if (values && def.mndMode() === BindingDefConst.MND_MODE_SUPPORT || def.mndMode() === BindingDefConst.MND_MODE_ONLY || (def.mndMode() === BindingDefConst.MND_MODE_SUPPORT_EXCLUSIVELY && values.length === 0)) {
                values.push(mnd);
                return;
            }
        }
...
// @formatter:off
define('sap/viz/vizservices/api/FeedService',[
    'sap/viz/vizservices/service/feed/FeedService',
    'require'
...
// @formatter:on
    ...
    /**
     * The FeedService contains the operations about the feed.
     * @namespace sap.viz.vizservices.FeedService
     */
    var FeedServiceAPI = sap.viz.vizservices.FeedService = {};

    /**
     * Validate the feedItems according to the given chart type.<br />
     * @memberOf sap.viz.vizservices.FeedService
     * @function validate
     * @param {String} type
     * @param {Array<FeedItem>} feedItems
     * FeedItem: JSON data structure with id and values. <br />
     ...
     * FeedItem.values is an array of AnalysisObject. values indicate the Dimensions or Measures which fed on the feed id.<br />
     * <br/ >
     * @return {Object<Boolean, Object>} Object with valid and Object.
     *  If valid is true,return value will be {"valid":true}.
     *  Else the return value will be {"valid":false,"results":Object}. Object has attribute(s) to indicate the failed reasons.
     * <br/ >
     * @example <caption>Sample Code:</caption>
     * //1. When valid bar chart and correct feedItems:
     * //Result will be
     * //{"valid": true}
     * 
     * 
     ...
     *      ]}
     * ];
     * var result = FeedService.validate(type, feedItems);
     * 
     * 
     * //2. When valid bar chart and feedItems that missing categoryAxis:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "bindings" :{
     ...
     * 
     * 
     * //3. When valid pie chart and feedItems that exceed size:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "bindings" :{
     ...
     * 
     * 
     * //4. When valid pie chart and feedItems that have incorrect analysis object:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "bindings" :{
     * //       "color" : {
     * //           "incorrect": [{"id":"dim_2","type":"Measure","dataType":"String"}]
     * //           }   
     * //       }
     * //   }
     * // } 
     ...
     * var feedItems = [
     *     {"id":"color","values":[
     *         {"id":"dim_2","type":"Measure","dataType":"String"}
     *     ]},
     *     {"id":"size","values":[
     *          {"id":"mea_1","type":"Measure","dataType":"Number"}
     *      ]}
     ...
     * 
     * 
     * //5. For trellis chart that miss trellis feedItem:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "bindings" : {
     ...
     * //           "missing": 1,
     * //           "allowMND":true,
     * //           "associate" : "trellisColumn"
     * //           },
     * //       "trellisColumn" : {
     * //           "missing": 1,
     * //           "allowMND":true,
     * //           "associate" : "trellisRow"
     * //           }
     * //       }
     * //    }
     * // }
     * 
     * var type = "info/trellis_bar";
     * var feedItems = [
     *     {"id":"categoryAxis","values":[
     *         {"id":"dim_2","type":"Dimension","dataType":"String"}
     *     ]},
     ...
     *  
     * 
     * //6. For MND logic, has more than one Measures:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "missingMND":true,
     ...
     * 
     * 
     * //7. For MND logic, has more than one Measures:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "missingMND":true,
     ...
     *          {"id":"mea_1","type":"Measure","dataType":"Number"}
     *     ]},
     *     {"id":"valueAxis2","values":[
     *          {"id":"mea_2","type":"Measure","dataType":"Number"}
     *     ]},     
     * ];
     * var result = FeedService.validate(type, feedItems);
     * 
     * //8. For MND logic, measureNames is invalid:
     * //Result will be
     * // {"valid": false,
     * //  "results" : {
     * //    "bindings" :{
     * //       "color" : {
     * //           "incorrect": [{"id":"MND","type":"MND","measureNames":["valueAxis2"]}]
     * //           }   
     * //       }
     * //   }
     * // }   
     ...
     *     {"id":"color","values":[
     *         {"id":"dim_2","type":"Dimension","dataType":"String"},
     *         {"id":"MND","type":"MND","measureNames":["valueAxis2"]}   
     *     ]},
     *     {"id":"valueAxis","values":[
     *          {"id":"mea_1","type":"Measure","dataType":"Number"}
     *      ]}
     ...
     * var result = FeedService.validate(type, feedItems);
     */
    FeedServiceAPI.validate = function(type, feedItems) {
        return FeedService.validate(type, feedItems);
    };
    
    return FeedServiceAPI;
});
